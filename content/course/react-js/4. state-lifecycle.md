...
### 1. Mounting Phase:
During this phase, a component is being created and added to the DOM.
...
### 2. Updating Phase:
This phase is triggered when a component's state or props change.
...
### 4. Error Handling:
These methods are called when an error is thrown during rendering, in a lifecycle method, or in a constructor.
